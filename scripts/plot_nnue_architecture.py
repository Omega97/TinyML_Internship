...
def plot_architecture(
    *,
    ...
    _group(
        ...
        l2_h,
        "L2 Expert Head",
        subtitle=f"N={NUM_BUCKETS} · Linear {concat_dim}→3 per bucket · WDL softmax · active head only",
    ...
    ax.text(
        0.3,
        -1.50,
        "Student: DualHidden WDL · L1 W=64 · L2=128 · CE vs Lc0 STM (W,D,L)",
        fontsize=8.5,
        color="#666666",
    )
    ax.text(
