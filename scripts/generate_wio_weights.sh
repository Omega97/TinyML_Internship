#!/bin/bash
# Re-runnable command to generate wio_weights.h using python -c
# Usage: bash scripts/generate_wio_weights.sh
# Or on Windows with Git Bash / WSL, or copy the python -c part.
