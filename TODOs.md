...
- [x] **Models**: list of model candidates
- [x] **MCU Deployment**: what is it about?
- [x] **Quantization**: How to perform (can it be done in Python??)
- [x] MicroPython
- [x] CircuitPython: what is it?
